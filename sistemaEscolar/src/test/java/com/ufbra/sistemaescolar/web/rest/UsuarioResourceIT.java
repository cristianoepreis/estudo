...
import static com.ufbra.sistemaescolar.domain.UsuarioAsserts.*;
...
import com.ufbra.sistemaescolar.repository.UsuarioRepository;
...
class UsuarioResourceIT {
    ...
    public static Usuario createEntity() {
        return new Usuario().nome(DEFAULT_NOME).email(DEFAULT_EMAIL).senha(DEFAULT_SENHA);
    }
    ...
    public static Usuario createUpdatedEntity() {
        return new Usuario().nome(UPDATED_NOME).email(UPDATED_EMAIL).senha(UPDATED_SENHA);
    }
    ...
    void partialUpdateUsuarioWithPatch() throws Exception {
        ...
        partialUpdatedUsuario.email(UPDATED_EMAIL);
