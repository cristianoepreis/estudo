...
export class DisciplinaUpdateComponent implements OnInit {
  ...
  protected loadRelationshipsOptions(): void {
    this.professorService
      ...
      .pipe(
        map((professors: IProfessor[]) =>
          this.professorService.addProfessorToCollectionIfMissing<IProfessor>(professors, this.disciplina?.professorResponsavel),
        ),
      )
    ...
    this.cursoService
      ...
      .pipe(map((cursos: ICurso[]) => this.cursoService.addCursoToCollectionIfMissing<ICurso>(cursos, ...(this.disciplina?.cursos ?? []))))
